...
5. **知识测验**：首次登录完成前测后解锁学习，并提示通过左上角菜单切换学习板块；有效学习满30分钟或教师统一发放后测时弹出提醒。A/B配对试卷包含基础知识20题×3分、皮疹辨别8题×2分、模拟案例8小题×3分，共36小题、100分。皮疹辨别前4题纯文字、后4题配图；前后卷设问与图片不同，考点对应。前测即时出分，提供逐题解析和知识问答跳转。
